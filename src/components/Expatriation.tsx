...
const NOTE_KEY = "expatriation_note";
...
export default function Expatriation() {
  ...
  return (
    <div className="chat-root expatriation">
      {/* RETOUR */}
      <button
        className="back-button-global expatriation"
        onClick={() => navigate("/")}
      ...
      <header className="chat-header">
        ...
        <span className="sub">
          Partagez votre expérience d’expatriation en toute sécurité
        </span>
      </header>
      ...
      <footer className="chat-footer">
        ...
        <input
          ...
          placeholder={
            userId
              ? "Partagez une expérience ou un ressenti…"
